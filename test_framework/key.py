...
class EllipticCurve:
    ...
    def has_even_y(self, p1):
        """Whether the point p1 has an even Y coordiinate when expressed in affine coordinates."""
...
class ECPubKey():
    ...
    def set(self, data):
        """Construct a public key from a serialization in compressed or uncompressed DER format or from the new BIP0340 format"""
...
def generate_schnorr_nonce():
    """Generate a random valid bip-0340 nonce.
